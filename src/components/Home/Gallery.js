			...
			<header className="section-heading mb-5 d-flex justify-content-between">
				<div className='div-categorys'>
					...
					{dropDown ? <div className='div-list-categorys'>
						<div className='d-flex align-items-center' role={'button'} onClick={()=> {setCategory('Allproducts');setDropDown(false)}}><span className='p-category' >All products</span><i className="ml-2 fa-solid fa-list"></i></div>
					    <div className='d-flex align-items-center' role={'button'} onClick={()=> {setCategory('TV');setDropDown(false)}}><span className='p-category' >TV</span><i className="ml-2 fa-solid fa-tv"></i></div>
					    <div className='d-flex align-items-center' role={'button'} onClick={()=> {setCategory('TELECOMMANDE');setDropDown(false)}}><span className='p-category' >Télécommande</span><i className="ml-2 fa-solid fa-laptop-file"></i></div>
					</div> : ""}
				</div>
